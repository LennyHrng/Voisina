...
const CACHE = "voisina-v2.3";
const SHELL = ["./", "./index.html", "./styles.css?v=2.3", "./voisina.js?v=2.3", "./theme-boot.js?v=2.3", "./fraunces-latin-600-normal.woff2", "./favicon.svg", "./manifest.webmanifest"];
