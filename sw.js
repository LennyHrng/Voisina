...
const CACHE = "voisina-v2.4";
const SHELL = ["./", "./index.html", "./styles.css?v=2.4", "./voisina.js?v=2.4", "./theme-boot.js?v=2.4", "./fraunces-latin-600-normal.woff2", "./favicon.svg", "./manifest.webmanifest"];
