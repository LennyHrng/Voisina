...
const CACHE = "voisina-v3.3";
const SHELL = ["./", "./index.html", "./styles.css?v=3.3", "./voisina.js?v=3.3", "./theme-boot.js?v=3.3", "./fraunces-latin-600-normal.woff2", "./favicon.svg", "./manifest.webmanifest"];
