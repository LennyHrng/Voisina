...
const CACHE = "voisina-v3.4";
const SHELL = ["./", "./index.html", "./styles.css?v=3.4", "./voisina.js?v=3.4", "./theme-boot.js?v=3.4", "./fraunces-latin-600-normal.woff2", "./favicon.svg", "./manifest.webmanifest"];
