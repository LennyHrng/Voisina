...
const CACHE = "voisina-v3.2";
const SHELL = ["./", "./index.html", "./styles.css?v=3.2", "./voisina.js?v=3.2", "./theme-boot.js?v=3.2", "./fraunces-latin-600-normal.woff2", "./favicon.svg", "./manifest.webmanifest"];
