...
const CACHE = "voisina-v2.5";
const SHELL = ["./", "./index.html", "./styles.css?v=2.5", "./voisina.js?v=2.5", "./theme-boot.js?v=2.5", "./fraunces-latin-600-normal.woff2", "./favicon.svg", "./manifest.webmanifest"];
